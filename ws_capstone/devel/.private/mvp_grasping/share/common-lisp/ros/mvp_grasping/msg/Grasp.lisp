...
(cl:in-package mvp_grasping-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Grasp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mvp_grasping-msg:<Grasp> is deprecated: use mvp_grasping-msg:Grasp instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvp_grasping-msg:pose-val is deprecated.  Use mvp_grasping-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'quality-val :lambda-list '(m))
(cl:defmethod quality-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvp_grasping-msg:quality-val is deprecated.  Use mvp_grasping-msg:quality instead.")
  (quality m))

(cl:ensure-generic-function 'entropy-val :lambda-list '(m))
(cl:defmethod entropy-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvp_grasping-msg:entropy-val is deprecated.  Use mvp_grasping-msg:entropy instead.")
  (entropy m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvp_grasping-msg:width-val is deprecated.  Use mvp_grasping-msg:width instead.")
  (width m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Grasp>)))
  ...
  "90c9438303b271d3a45352442c7a7579")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Grasp)))
  "Returns md5sum for a message object of type 'Grasp"
  "90c9438303b271d3a45352442c7a7579")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Grasp>)))
  ...
  (cl:format cl:nil "geometry_msgs/Pose pose~%float32 quality~%float32 entropy~%float32 width~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Grasp)))
  "Returns full string definition for message of type 'Grasp"
  (cl:format cl:nil "geometry_msgs/Pose pose~%float32 quality~%float32 entropy~%float32 width~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
