...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/nuwan/git/vision_grasp_capstone/ws_capstone/src/main)
  set(main_DEVEL_PREFIX /home/nuwan/git/vision_grasp_capstone/ws_capstone/devel/.private/main)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/nuwan/git/vision_grasp_capstone/ws_capstone/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuwan/git/vision_grasp_capstone/ws_capstone/src/main/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nuwan/git/vision_grasp_capstone/ws_capstone/devel/.private/main/lib;/home/nuwan/git/vision_grasp_capstone/ws_capstone/devel/lib;/opt/ros/melodic/lib)
