...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/liam/git/vision_grasp_capstone/ws_capstone/src/main)
  set(main_DEVEL_PREFIX /home/liam/git/vision_grasp_capstone/ws_capstone/devel/.private/main)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/liam/git/vision_grasp_capstone/ws_capstone/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'ye <1@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/liam/git/vision_grasp_capstone/ws_capstone/src/main/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/liam/git/vision_grasp_capstone/ws_capstone/devel/.private/main/lib;/home/liam/git/vision_grasp_capstone/ws_capstone/devel/lib;/home/liam/git/vision_grasp_capstone/ws_capstone/devel/.private/catkin_tools_prebuild/lib;/home/liam/catkin_ws/devel/lib;/opt/ros/melodic/lib)
